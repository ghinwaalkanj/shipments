...
import 'package:shipment_merchent_app/features/shipment/screen/widgets/shippments_shimmer_widget.dart';
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Padding(
                          ...
                          child: GestureDetector(
                            onTap:(){
                              print(controller.shipments[index].shipmentId);
                              Get.to(TrackingScreen(shipmentId: controller.shipments[index].shipmentId));
                            },
                            child: Container(
